    ...
    <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
      ...
      <div className="space-y-6 ng-untouched ng-pristine ng-valid items-center flex justify-center">
        <div className="flex flex-col items-center">
          <div>
            <button className="flex justify-center px-4 py-4 bg-gray-800 hover:bg-gray-600 border border-gray-500 items-center text-center font-medium rounded-lg gap-4">
