...
function Loader({}: Props) {
  return (
    <ClientOnly>
      <div className="bg-gradient-to-r from-[#191a47] via-[#0d0d37] to-[#06375f] h-screen flex justify-center items-center">
        <div className="px-4 py-12">
          <div className="rounded relative bg-transparent py-12">
            <div className="rounded-full  w-[177px] h-[177px] relative flex justify-center items-center mx-auto animate-spin">
              <svg
